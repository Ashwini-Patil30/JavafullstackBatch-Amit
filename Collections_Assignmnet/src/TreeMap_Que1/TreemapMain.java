...
public class TreemapMain {
	...
	public static void main(String[] args) {
		...
		Contact c1 = new Contact("ashu","ashu@gmail.com");
		Contact c2 = new Contact("priyu","priyu@gmail.com");
		Contact c3 = new Contact("new","new@gmail.com");
		...
		System.out.println(entry.getValue());//use to get only value	
